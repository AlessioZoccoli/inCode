...
def minaceLecter():
    ...
    text = "A B C D E F G H I L M N O P Q R S T U X a b c d e f g h i l m n o p q r s t u x , . Ca Ga ce con curl curly_dash de eg epo ex fa fi gl nt pa per pro prop que qui rum semicolon si ue us"
